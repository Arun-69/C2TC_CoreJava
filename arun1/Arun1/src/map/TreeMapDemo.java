package map;
	...
	public class TreeMapDemo {
		...
		public static void main(String[] args) {
			...
			students.put(new Student(102, "ASIQ", 72), "FY");
			students.put(new Student(104, "HARI", 71), "SY");
			students.put(new Student(103, "GURU", 87), "BE");
			...
			t.put(new Student(102, "ASIQ", 72), "FY");
			t.put(new Student(104, "HARI", 71), "SY");
			t.put(new Student(103, "GURU", 87), "BE");
